    ...
    <body>
		...
		%>
                    <tr>
                        ...
                        <td class="td_modi">
                            <input type="button" value="<%=sv.getStatus().equals("1")?"暂停":"开通" %>" class="btn_pause" onclick="location.href='<%=request.getContextPath()%>/lanqiao/BussinessAccountOpenAction?id=<%=sv.getBussinessId() %>&status=<%=sv.getStatus() %>';" />
