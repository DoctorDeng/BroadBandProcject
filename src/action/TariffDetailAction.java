...
/**
 * Servlet implementation class TariffDetailAction
 */
@WebServlet(urlPatterns="/TariffDetailAction")
public class TariffDetailAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TariffDetailAction() {
        super();
