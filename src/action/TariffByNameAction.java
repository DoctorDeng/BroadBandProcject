...
/**
 * Servlet implementation class TariffByName
 */
@WebServlet(urlPatterns="/TariffByNameAction")
public class TariffByNameAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TariffByNameAction() {
        super();
